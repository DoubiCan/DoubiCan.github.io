...
为了支持真实场景下的模型测试:1.决定从老师的[这篇文章]()上进行`事件输入`的改造。2.并在一个真实世界的数据上进行测试(数据来源于V2E的测试视频,觉得刚好适用小目标模型就直接用了--嘻嘻)


<div style="text-align: center;">
  <!-- 使用 Flex 布局实现水平排列 -->
  <div style="display: flex; justify-content: center; gap: 5px;">
    <img src='/images/Event_STMD_MathV1/Experiment real environment/events/frame_viz_113.png' style="width: 40%;">
    <p>frame_viz_113</p>
    <img src='/images/Event_STMD_MathV1/Experiment real environment/events/Response_frame_113_ESTMD.jpg' style="width: 40%;">
    <p>Response_frame_113_ESTMD</p>
    <img src='/images/Event_STMD_MathV1/Experiment real environment/events/Response_frame_113_Feedback_stmd.jpg' style="width: 40%;">
    <p>Response_frame_113_Feedback_stmd</p>
  </div>
</div>
...
<div style="text-align: center;">
  <!-- 使用 Flex 布局实现水平排列 -->
  <div style="display: flex; justify-content: center; gap: 5px;">
    <img src='/images/Event_STMD_MathV1/Experiment real environment/video_para2/frame_113_video_para1.jpg' style="width: 30%;">
    <p>frame_113_video</p>
    <img src='/images/Event_STMD_MathV1/Experiment real environment/video_para2/Response_frame_LMC_116_video_para2.jpg' style="width: 30%;">
    <p>Response_frame_LMC_116_video_para2</p>
    <img src='/images/Event_STMD_MathV1/Experiment real environment/video_para2/Response_frame_ESTMD_116_video_para2.jpg' style="width: 30%;">
    <p>Response_frame_ESTMD_116_video_para2</p>
    <img src='/images/Event_STMD_MathV1/Experiment real environment/video_para2/Response_frame_Feedback_113_video_para2.jpg' style="width: 30%;">
    <p>Response_frame_Feedback_113_video_para2</p>
  </div>
</div>
...
- [x] 不知道应该读哪些文章，目前规划是先看看课题组老师们师兄们的论文
- [ ] 灵敏度测试:1.时间划分窗口 2.
