...
date: 2099-02-25
permalink: /posts/2099/02/blog-post-3/
tags:
  - Math
  - STMD
  - Event_based
...
<div style="background-color:rgb(123, 123, 123); padding: 10px; border-radius: 5px;">
...
\\
\overset{\text{\tiny{注意到|$\frac{负}{负}\cdot \frac{正}{正}$|$\cdot$|$\frac{正}{正}\cdot\frac{正}{正}$ |}}}{\underset{\text{\tiny{因此绝对值可去}}}{}}&=\left( \frac{1+\frac{b+a}{I(t_2)-I(t_1)}\cdot\frac{\alpha \cdot (I(t_2)-I(t_1))}{t_2-t_1}}{1+\frac{b+a}{I(t_2)-I(t_1)}} \right) \cdot \left( \frac{1-\frac{b+a}{I(t_2^{'})-I(t_1^{'})}\cdot\frac{\beta \cdot (I(t_2^{'})-I(t_1^{'}))}{t_2^{'}-t_1^{'}}}{1-\frac{b+a}{I(t_2^{'})-I(t_1^{'})}} \right) \nonumber
\\
\overset{\text{\tiny{记$k=\alpha \cdot \frac{\alpha \cdot (I(t_2)-I(t_1))}{t_2-t_1}$}}}{\underset{\text{\tiny{记K=$\frac{\beta \cdot (I(t_2^{'})-I(t_1^{'}))}{t_2^{'}-t_1^{'}}$}}}{}}&=\left( k-\frac{k-1}{1+\frac{b+a}{I(t_2)-I(t_1)}} \right) \cdot \left( K-\frac{K-1}{1-\frac{b+a}{I(t_2^{'})-I(t_1^{'})}} \right) \nonumber
\\
&至此我们可以计算期望 \nonumber
\\
